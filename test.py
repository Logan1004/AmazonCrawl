...
fp = open("/Users/logan/Desktop/DataFactory/Homework1/Final/Part7.txt", 'w+')
...
#html = crawl("https://www.amazon.com/dp/B003AI2VGA")
...
def loadData(fileName,num):
    ...
    with open(fileName) as txtData:
        ...
        for line in lines:
            ...
            #time_sleep = random.random() + random.randint(0,5)
...
if __name__ == '__main__':
    ...
    num = loadData("/Users/logan/Desktop/DataFactory/Homework1/Final/7.txt", 0)
    print(num)
